...
| `--workgraph-compaction-reasoning-level`                     | `WORKGRAPH_COMPACTION_REASONING_LEVEL`                     | "off", "minimal", "low", "medium", "high", "xhigh", "max" | Opt-in: change the reasoning level for compaction                                                                                     |
